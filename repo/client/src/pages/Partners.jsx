...
const Partners = () => {
  return (
    ...
    <section className="section-padding bg-brand-surface relative overflow-hidden">
      <div className="orb w-[400px] h-[400px] bg-brand-primary/5 top-0 left-0 -translate-x-1/3 -translate-y-1/3 pointer-events-none" />
      <div className="container-wide relative">
        <div className="text-center mb-10">
          ...
          <p className="text-brand-muted mt-4 text-sm max-w-2xl mx-auto">
            Our SI partners bring the enterprise relationships, delivery capability, and domain expertise that take sovereign AI from proof-of-concept to production.
          </p>
        </div>
        <LogoGrid items={siPartners} />
      </div>
    </section>

    {/* Technology Partners */}
    <section className="section-padding bg-brand-surface relative overflow-hidden">
      <div className="orb w-[500px] h-[500px] bg-brand-accent/5 bottom-0 right-0 translate-x-1/4 translate-y-1/4 pointer-events-none" />
      <div className="container-wide relative">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {techPartners.map(({ name, desc, tag, Icon, icons, chips, color, logo, lc }, i) => (
            <motion.div key={name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass-card rounded-2xl p-6">
