...
const layers = [
  ...
  },
  {
    ...
    desc: 'LLMOps, agent orchestration, agent registry, and memory — running on your hardware, grounded in the data layer beneath it.',
    chips: ['LLMOps', 'Orchestration', 'Registry', 'Memory'],
    Icon: AstronautMark,
    tone: 'dark',
  },
  {
